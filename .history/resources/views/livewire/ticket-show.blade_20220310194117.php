        ...
        <div class="flex justify-between px-5 py-5 space-x-3">
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col font-interstate">
                    ...
                    <div class="flex flex-col w-2/3 px-2 py-2 mt-4 space-y-2 font-light border divide-y bg-slate-600 rounded-xl text-slate-200 ">
                        <div class="px-2 pt-2">
                            <div class="inline-block w-1/6 ">IP addres:</div>
                            <div class="inline-block w-4/6 font-base text-slate-500 font-mono45">{{ $ticket->ipaddress }}</div>
                        </div>
                        <div class="px-2 pt-2 ">
                            <div class="inline-block w-1/6 align-top">Device:</div>
                            <div class="inline-block w-4/6 font-base text-slate-500 font-mono45">{{ $ticket->device }}</div>
                        </div>
                    </div>
                </div>
            </div>
