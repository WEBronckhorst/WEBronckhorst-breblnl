            ...
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col">
                    ...
                    <article class="w-full px-4 py-4 mt-3 rounded-xl bg-slate-100">
                        <h2 class="text-xl font-semibold font-interstate-condensed text-blauw">{{ $ticket->title }}</h2>
                        {!! $ticket->description !!}
                    </article>
                    <div class="px-4 py-4 mt-4 font-light border rounded-xl text-slate-400 ">
                        <div class="flex space-x-2 "><span>IP addres:</span> <span class="font-semibold text-slate-500 ">{{ $ticket->ipaddress }}</span></div>
                        <div class="flex space-x-2"><span >Device:</span> <span class="font-semibold text-slate-500">{{ $ticket->device }}</span></div>
                    </div>
                </div>
            </div>
