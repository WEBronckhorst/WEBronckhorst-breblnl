<div class="">
   ...
   <form  wire:submit.prevent="save">
    <div class="">
        ...
        <div class="px-5 py-5 ">
            <input wire:model="posts.{{ $index }}.title" type="text" name="" id="" class="w-full px-2 py-2 border-2 rounded-md border-slate-300 ring-0 focus:outline-none focus:ring-blauw focus:border-blauw placeholder:text-gray-500 placeholder:font-semibold placeholder:text-sm" placeholder="Ticket Titel">
        </div>
    </div>
    <div class="">
