            ...
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col font-interstate">
                    ...
                    <div class="flex justify-start w-1/2 px-4 py-4 mt-4 text-sm font-light border rounded-xl text-slate-400 ">
                        <div class="flex flex-col space-y-2 divide-y w-36">
                            <span>IP addres:</span><br/>
                            <span >Device:</span>
                        </div>
                        <div class="flex flex-col space-y-2">
                            <span class="font-semibold text-slate-500 font-mono45 ">{{ $ticket->ipaddress }}</span>
                            <span class="font-semibold text-slate-500 font-mono45">{{ $ticket->device }}</span><br/>
                        </div>
