            ...
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="text-slate-600 ">
                        <div class="flex space-x-2"><span class=" text-slate-400">ipaddress:</span> <span>{{ $ticket->ipaddress }}</span></div>
                        <div class="flex space-x-2"><span class=" text-slate-400">device:</span> <span>{{ $ticket->device }}</span></div>
                    </div>
                </div>
            </div>
