            ...
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col font-interstate">
                    <div class="">
                        ...
                        <span class="mark_status_{{ $ticket->state }}" style="border-radius: 12px; height: 24px;"> Beherder </span>
                    </div>
                ...
                <div class="mark_status_1"></div>
                <div class="mark_status_2"></div>
                <div class="mark_status_3"></div>
                <div class="mark_status_4"></div>
            </div>
