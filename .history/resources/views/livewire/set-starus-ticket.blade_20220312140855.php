                ...
                <fieldset class="mt-4">
                    ...
                    <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                        <div class="flex items-center">
                            ...
                            <input wire:model="status" id="open" name="Status" type="radio" value="1" @if ($ticket->state == 1) checked @endif  class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                            <label for="Open" class="block ml-3 text-sm font-medium text-gray-700"> Open </label>
                        </div>

                        <div class="flex items-center">
                            <input wire:model="status" id="inBehandeling" name="Status" type="radio" value="2"  @if ($ticket->state == 2) checked @endif class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                            <label for="inBehandeling" class="block ml-3 text-sm font-medium text-gray-700">  in behandeling </label>
                        </div>
                        <div class="flex items-center">
                            <input wire:model="status" id="afgerond" name="Status" type="radio" value="3" @if ($ticket->state == 13) checked @endif class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                            <label for="afgerond" class="block ml-3 text-sm font-medium text-gray-700">  Afgerond </label>
                        </div>
                        <div class="flex items-center">
                            <input wire:model="status" id="annuleert" name="Status" type="radio" value="4"  @if ($ticket->state == 4) checked @endif class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
