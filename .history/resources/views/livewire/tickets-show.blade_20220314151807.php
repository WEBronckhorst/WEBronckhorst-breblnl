        ...
        <div class="flex items-center px-4 py-4 sm:px-6">
            <div class="flex items-center flex-1 min-w-0">
                ...
                <div class="mr-5">
                    ...
                    <span class="mark_status_{{ $ticket->status->id }} no-underline" style="border-radius: 12px; height: 24px;">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mt-[2px] mr-2 px-3 py-2" viewBox="0 0 20 20" fill="currentColor">
