<div class="">
    ...
    <div class="">
        ...
        <div class="px-5 py-5 pt-1 ">
            <div class="w-full form-textarea" x-data="editorApp()" x-init="init($dispatch)" wire:ignore wire:key="ckEditor" x-ref="ckEditor" wire:model.debounce.9999999ms="description">{!! $content !!}</div
        </div>
    </div>
    <div class="">
