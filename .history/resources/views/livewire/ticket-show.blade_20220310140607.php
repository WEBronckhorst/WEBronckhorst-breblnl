        ...
        <div class="flex justify-between px-5 py-5 space-x-3">
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col">
                    <div class="">
                        <h3 class="py-0 my-0 text-lg font-semibold">{{ $ticket->User->name }} @admin <a class="inline-flex items-center px-3 font-medium no-underline transition-all border border-solid border-deep-black/3 bg-grey-200 hover:border-deep-black/10 hover:bg-grey-300 mobile:flex mobile:items-center mobile:p-2 mobile:text-sm md:text-xs text-grey-800" title="Original Poster" style="border-radius: 12px; height: 24px;"> OP </a> @endadmin</h3>
