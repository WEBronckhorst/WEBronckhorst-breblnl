        ...
        <div class="flex justify-between px-5 py-5 space-x-3">
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="">
                        <div class=""><span>ipaddress:</span> <span>{{ $ticket->ipaddress }}</span></div>
                        <div class=""><span>ipaddress:</span> <span>{{ $ticket->macAddress }}</span></div>
                        <div class=""><span>ipaddress:</span> <span>{{ $ticket->device }}</span></div>
                    </div>
                </div>
            </div>
