        ...
        <div class="flex justify-between px-5 py-5 space-x-3">
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="px-4 py-4 mt-5 font-light border rounded-xl text-slate-200 ">
                        <div class="flex space-x-2 "><span class="">IP addres:</span> <span class="font-semibold text-slate-600 ">{{ $ticket->ipaddress }}</span></div>
                        <div class="flex space-x-2"><span class=" text-slate-200">Device:</span> <span class="font-semibold text-slate-600">{{ $ticket->device }}</span></div>
                    </div>
                </div>
            </div>
