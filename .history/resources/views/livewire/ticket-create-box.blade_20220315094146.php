<div class="">
   ...
   <form  wire:submit.prevent="save" class="@if($showSucses) hidden @endif">
    ...
    <a href="{{ route('ticket.show', $ticket_id ?? '') }}" class="px-4 py-2 mt-5 font-semibold text-white no-underline rounded-md text-md bg-blauw hover:bg-blauw-hover">Open ticket</a>
    </div>
