            ...
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col font-interstate">
                    ...
                    <div class="w-1/2 px-4 py-4 mt-4 text-sm font-light border rounded-xl text-slate-400 ">
                        <div class="flex justify-start space-x-2 "><div class="w-40 ">IP addres:</div> <span class="font-semibold text-slate-500 font-mono45 ">{{ $ticket->ipaddress }}</span></div>
                        <div class="flex justify-start space-x-2 "><div class="w-40 ">Device:</div> <span class="font-semibold text-slate-500 font-mono45">{{ $ticket->device }}</span></div>
                    </div>
                </div>
            </div>
