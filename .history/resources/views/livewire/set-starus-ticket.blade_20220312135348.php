                ...
                <fieldset class="mt-4">
                  ...
                  <div class="space-y-4">
                    <div class="flex items-center">
                      <input wire:model="status" id="open" name="Status" type="radio" checked class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                    ...
                    <div class="flex items-center">
                      <input wire:model="status" id="afgerond" name="status type="radio" class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
