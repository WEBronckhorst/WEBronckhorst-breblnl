        ...
        <div class="flex justify-between px-5 py-5 space-x-3">
            <div class="flex justify-start space-x-3">
                ...
                <div class="flex flex-col font-interstate">
                    ...
                    <div class="flex flex-col w-1/2 px-1 py-4 mt-4 space-y-2 text-sm font-light border divide-y rounded-xl text-slate-400 ">
                        <div class="px-2 pt-2">
                            <div class="inline-block w-1/5 ">IP addres:</div>
                            <div class="inline-block w-3/5 font-semibold text-slate-500 font-mono45">{{ $ticket->ipaddress }}</div>
                        </div>
                        <div class="px-2 pt-2 ">
                            <div class="inline-block w-1/5 align-top">Device:</div>
                            <div class="inline-block w-3/5 font-semibold text-slate-500 font-mono45">{{ $ticket->device }}</div>
                        </div>
                    </div>
                </div>
            </div>
