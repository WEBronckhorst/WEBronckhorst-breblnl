    ...
    <div class="row-span-2 bg-white rounded-lg shadow-card">
        ...
        <nav class="px-4 py-5 space-y-2" aria-label="Sidebar">
            <a href="#" class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-md hover:bg-gray-50 hover:text-gray-900">
                ...
                <a wire:click.prevent="setStatus('In behandeling')" href="#" class=" flex items-center px-3 py-2 text-sm font-medium text-gray-600  rounded-md hover:hover:text-gray-900  no-underline @if ($status === 'In Progress') bg-blauw  text-white @else bg-gray-200  @endif">In Progress ({{ $statusCount['in_progress'] }})</a>
