            ...
            <div class="w-full max-w-3xl px-5 pt-10 pb-4 mx-auto bg-white border shadow-card rounded-t-xl ">
                ...
                <fieldset class="mt-4">
                    ...
                    <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                        <div class="flex items-center">
                            ...
                            <input wire:model="status" id="open" name="status" type="radio" value="1"   class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                        ...
                        <div class="flex items-center">
                            <input wire:model="status" id="annuleert" name="status" type="radio" value="4"    class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                ...
                <div class="">
                    <div class="flex justify-end pt-4">
                        <input type="submit" value="Submit" @click.outside="open = false" id="submit" class="bt-blauw">
                    </div>
                </div>
            </div>
        </form>
