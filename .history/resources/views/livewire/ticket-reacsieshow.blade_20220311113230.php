<div>
    <div class="w-full col-span-4 bg-white rounded-xl shadow-card border-1 border-slate-400  @if(auth()->user()->isAdmin()) border-blauw @endif ">
        <div>
