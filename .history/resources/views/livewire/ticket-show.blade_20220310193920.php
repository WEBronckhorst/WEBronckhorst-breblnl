                ...
                <div class="flex flex-col font-interstate">
                    ...
                    <div class="flex flex-col w-2/3 px-2 py-4 mt-4 space-y-2 text-sm font-light border divide-y rounded-xl text-slate-400 ">
                        <div class="px-2 pt-2">
                            ...
                            <div class="inline-block w-4/6 font-semibold text-slate-500 font-mono45">{{ $ticket->ipaddress }}</div>
                        </div>
                        <div class="px-2 pt-2 ">
                            <div class="inline-block w-1/6 align-top">Device:</div>
                            <div class="inline-block w-5/6 font-semibold text-slate-500 font-mono45">{{ $ticket->device }}</div>
                        </div>
                    </div>
                </div>
            </div>
