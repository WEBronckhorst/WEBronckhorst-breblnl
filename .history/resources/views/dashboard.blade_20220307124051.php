...
<x-app-layout>
    ...
    <div class="grid grid-flow-col grid-cols-4 gap-4 ">
        ...
        <div class="grid grid-flow-col grid-cols-2 col-span-2 row-span-2 gap-4 pb-10 ">
            <div class="justify-between col-span-2 space-x-4 row-span-3flex ">
            ...
            <div class="col-span-2 row-span-1 mb-6 bg-white rounded-lg shadow-card">
