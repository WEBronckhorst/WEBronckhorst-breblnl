...
<x-app-layout>
    ...
    <div class="grid grid-flow-col grid-cols-5 gap-4 ">
        ...
        <div class="col-span-2 row-span-1 pb-10 ">
            <div class="justify-between col-span-3 space-x-4 row-span-3flex ">
            ...
            <!-- This example requires Tailwind CSS v2.0+ -->
            <div class="col-span-1 row-span-2 mb-6 bg-white rounded-lg shadow-card">
