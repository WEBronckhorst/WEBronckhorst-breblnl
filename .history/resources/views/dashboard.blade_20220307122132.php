...
<x-app-layout>
    ...
    <div class="grid grid-flow-col grid-rows-2 gap-4 ">
       <div class="text-sm font-bold leading-6 text-center text-gray-500 rounded-lg bg-stripes-fuchsia">
        ...
        <div class="grid col-span-2 row-span-2 col-2">
            <div class="flex justify-between space-x-4 ">
                <div class="w-2/5 col-span-1 bg-white rounded-lg shadow-card mb-9">
                ...
                <div class="flex-1 col-span-3 row-span-3 bg-white rounded-lg shadow-card mb-9 ">
                    <div class="flex justify-between px-5 py-5 space-x-2 border-b">
