...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="https://use.typekit.net/xyl8bbk.css">
    ...
    <body class="antialiased font-dinosaur bg-slate-100">
        ...
        <div>
            ...
            <div class="container px-6 mx-auto">
                ...
                <div class="relative w-full h-64 mb-8 -mt-12 rounded ">
