    ...
    <body class="font-sans antialiased bg-slate-100">
        ...
        <script>
            CKEDITOR.replace('description_simpel', {
                height: 800,
                removeButtons: 'Underline,Strike,Subscript,Superscript,Anchor,Styles,Specialchar,PasteFromWordCut,Copy,Paste,Undo,Redo,Anchor,Underline,Strike,Subscript,Superscript'
            });
        </script>
